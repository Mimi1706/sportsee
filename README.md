...
- [React](https://reactjs.org): v18.0.0 (WARNING! React v18.0.0 displays incompatibilies with npm therefore we recommend using React v17.0.0 instead for npm)
...
- Install the dependencies with `yarn install` or `npm install` (WARNING! React v18.0.0 displays incompatibilies with npm therefore we recommend using React v17.0.0 instead for npm)
